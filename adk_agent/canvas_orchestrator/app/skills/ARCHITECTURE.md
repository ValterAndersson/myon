...
| `coach_skills.py` | SLOW (read tools) | Analytics and user data retrieval: `get_training_context`, `get_user_profile`, `search_exercises`, `get_exercise_details`, `get_muscle_group_progress`, `get_muscle_progress`, `get_exercise_progress`, `get_coaching_context`, `query_training_sets` |
...
| SLOW | `coach_skills` (read) + `planner_skills` (write) | Pro |
| WORKER | `progression_skills` | Pro |
