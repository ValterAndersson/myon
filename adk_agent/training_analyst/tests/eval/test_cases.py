...
AUTO_PILOT_CASES = [
    RecommendationTestCase(
        ...
        expected_signals=["100kg", "8 reps", "3 weeks", "RIR 2"],
    ...
    RecommendationTestCase(
        ...
        expected_rec_type="progression",
        expected_signals=["120kg", "5 reps", "4 weeks"],
    ...
    RecommendationTestCase(
        ...
        expected_signals=["80kg", "RIR", "fatigue"],
...
PENDING_REVIEW_CASES = [
    ...
    RecommendationTestCase(
        ...
        expected_rec_type="deload",
        expected_signals=["140kg", "fatigue", "RIR"],
    ...
    RecommendationTestCase(
        ...
        expected_rec_type="deload",
        expected_signals=["65kg", "7 weeks", "stalled", "swap"],
        gold_summary="Consider swapping Lat Pulldown after 7-week plateau",
        gold_rationale="e1RM flat at 65kg for 7 consecutive weeks. Extended stall suggests exercise swap may be more effective than weight change.",
        quality_requirements=[
            "Stall duration mentioned",
            "Swap suggested (not just weight change)",
            "Explains why swap over deload",
        ],
        tags=["stall", "swap", "extended_plateau"],
    ),
    RecommendationTestCase(
        id="pr_010",
        category="pending_review",
...
EXERCISE_SCOPED_CASES = [
    RecommendationTestCase(
        ...
        expected_rec_type="progression",
        expected_signals=["80kg", "8 reps", "3 weeks"],
    ...
    RecommendationTestCase(
        ...
        expected_rec_type="progression",
        expected_signals=["20kg", "2 weeks"],
        gold_summary="Goblet Squat looking consistent at 20kg",
        gold_rationale="Only 2 weeks of data. Too early for confident progression — keep building consistency. Use this weight for 1-2 more weeks.",
        quality_requirements=[
            "Gentle language",
            "No aggressive progression with minimal data",
        ],
        tags=["new_user", "conservative", "no_routine"],
    ),
    RecommendationTestCase(
        id="es_005",
        category="exercise_scoped",
    ...
    RecommendationTestCase(
        ...
        expected_rec_type="progression",
        expected_signals=["60kg", "1 week"],
        gold_summary="Barbell Squat: keep building at 60kg",
        gold_rationale="Only 1 week of history. Focus on consistent form before increasing weight.",
        quality_requirements=[
            "Very conservative",
            "No weight change suggested",
            "Form focus",
        ],
        tags=["sparse_data", "conservative", "no_routine"],
    ),
    RecommendationTestCase(
        id="es_008",
        category="exercise_scoped",
    ...
    RecommendationTestCase(
        ...
        expected_rec_type="deload",
        expected_signals=["45kg", "5 weeks", "plateau"],
        gold_summary="Overhead Press: plateau observed at 45kg for 5 weeks",
        gold_rationale="e1RM flat for 5 weeks. Consider a deload week or varying rep range (try 5x5 at higher weight or 3x12 at lower).",
        quality_requirements=[
            "Plateau language",
            "Actionable suggestions",
            "No template references",
        ],
        tags=["stall", "plateau", "no_routine"],
    ),
    RecommendationTestCase(
        id="es_010",
        category="exercise_scoped",
