...
public enum MyonButtonStyleKind {
    case primary
    case secondary
    case ghost
    case destructive
...
public struct MyonButton: View {
    private let title: String
    private let style: MyonButtonStyleKind
    ...
    public init(_ title: String, style: MyonButtonStyleKind = .primary, leadingIcon: Image? = nil, trailingIcon: Image? = nil, action: @escaping () -> Void) {
        self.title = title
        self.style = style
...
#if DEBUG
struct MyonButton_Previews: PreviewProvider {
    static var previews: some View {
        VStack(spacing: Space.md) {
            MyonButton("Primary") {}
            MyonButton("Secondary", style: .secondary) {}
            MyonButton("Ghost", style: .ghost) {}
            MyonButton("Delete", style: .destructive) {}
        }
